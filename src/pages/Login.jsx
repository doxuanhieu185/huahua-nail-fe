    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-pink-50 to-purple-50 p-4">
      <div className="w-full max-w-md bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl">
        <div className="text-center mb-8">
          ...
          <p className="text-[#6B556B]">Đăng nhập</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="relative flex items-center">
            ...
            <input
              type="email"
              value={formData.email} // Thêm giá trị
              onChange={(e) =>
          ...
          <div className="flex items-center justify-between text-sm">
            <label className="flex items-center">
              <input
                type="checkbox"
                className="rounded border-pink-200 text-pink-400 focus:ring-pink-300"
              />
              <span className="ml-2 text-[#6B556B]">Remember me</span>
            </label>
            <button
              type="button"
              className="text-[#6B556B] hover:underline focus:outline-none"
            >
              Forgot Password?
            </button>
          </div>
          ...
          {/* Hiển thị lỗi nếu có */}
          {errors.submit && (
            <div className="p-3 rounded-lg bg-red-50 text-red-400 text-sm text-center">
              {errors.submit}
            </div>
          )}
        </form>
        ...
        <p className="mt-8 text-center text-[#6B556B]">
          ...
          <button className="font-semibold text-pink-400 hover:underline focus:outline-none">
            Sign up
          </button>
        </p>
      </div>
